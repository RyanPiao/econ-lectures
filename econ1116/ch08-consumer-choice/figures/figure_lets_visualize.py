...
ax.annotate('4 lbs Beef', xy=(0, 4), xytext=(-3.0, 4.2),
            fontsize=14, weight='bold', color='#dc2626', ha='center')

ax.plot(8, 2, 'o', color='#ea580c', markersize=18, zorder=6,
        markeredgecolor='#9a3412', markeredgewidth=1.5)
ax.annotate('2 lbs Beef\n+ 8 Avocados', xy=(8, 2), xytext=(8.4, 2.8),
...
ax.annotate('16 Avocados', xy=(16, 0), xytext=(15.4, 0.45),
...
ax.text(8, 4.3, 'The Budget Line — $16 Budget', fontsize=14, weight='bold',
